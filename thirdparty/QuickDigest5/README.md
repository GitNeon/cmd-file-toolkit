...
QuickDigest5 is a lightweight C++ library for computing MD5 hashes of strings and files. Designed for simplicity and
efficiency, it provides static utility methods to generate MD5 hashes and convert them to hexadecimal string
representations.
...
QuickDigest5 is licensed under the [GNU General Public License v3](License). You are free to use, modify, and distribute
this library under the terms of the license.
