...
namespace logger
{
    namespace
    {
        ...
        std::string Timestamp()
        {
            ...
            static_cast<void>(std::snprintf(buf.data(),
                                            buf.size(),
        ...
        void Log(Level level, const std::string& msg)
        {
            ...
            const std::string LINE = "[" + Timestamp() + "] [" + LevelTag(level) + "] " + msg + "\n";
    ...
    {
        Log(Level::LG_DEBUG, msg);
    }

    void Info(const std::string& msg)
    {
        Log(Level::LG_INFO, msg);
    }

    void Warning(const std::string& msg)
    {
        Log(Level::LG_WARNING, msg);
    }

    void Error(const std::string& msg)
    {
        Log(Level::LG_ERROR, msg);
    }
}  // namespace logger
